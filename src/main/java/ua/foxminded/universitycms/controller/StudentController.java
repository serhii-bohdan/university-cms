...
public class StudentController {
     ...
     * @return the logical view name {@code students/all-students} representing the student list template
     */
    @GetMapping
     ...
     * <p>
     * This method handles GET requests to the {@code /ui/v1/students/not-enrolled} endpoint. It retrieves a list of
     * students not currently enrolled in the course with the provided {@code courseId} using the {@code studentService}.
     * Students can be optionally filtered based on a search keyword for email addresses. The list of students and any
     * extracted student emails are added to the model for display.
     *
     * @param model    the Spring MVC Model object used to store data for the view
     * @param courseId the ID of the course
     * @param keyword  an optional search keyword for filtering students by email (can be blank)
     * @return the logical view name {@code students/not-enrolled-in-course} representing the list of not enrolled
     * students
     */
     ...
     * <p>
     * This method handles GET requests to the {@code /ui/v1/students/{studentId}} endpoint. It retrieves the student
     * with the provided {@code studentId} using the {@code studentService}. If the student is found, the method adds
     * the student data to the model for display in the particular student view.
     *
     * @param model     the Spring MVC Model object used to store data for the view
     ...
     * @return the name of the view to navigate to after the student is successfully added, or the form view if
     ...
     * <p>
     * This method handles GET requests to the {@code /ui/v1/students/{studentId}/edit} endpoint. It fetches the
     * student data for the given {@code studentId} using the {@link StudentService}. If the student is found,
     * the method adds the student data and a list of all existing groups to the model, preparing it for
     * display in the update form. Users must have the {@code STUDENTS_UPDATE} authority to access this endpoint.
     *
     * @param model     the Spring MVC Model object used to store data for the view
     ...
     * <p>
     * This method processes PUT requests to the {@code /ui/v1/students/update} endpoint. It validates the
     ...
     * Users must have the {@code STUDENTS_UPDATE} authority to access this endpoint.
     *
     * @param model         the Spring MVC Model object used to store data for the view
     ...
     * <p>
     * This method processes DELETE requests to the {@code /ui/v1/students/{studentId}/delete} endpoint.
     * It attempts to delete the student with the specified ID using the {@link StudentService}.
     * If the deletion is successful, it redirects to the URL displaying all students. Users must have the
     * {@code STUDENTS_DELETE} authority to access this endpoint.
     *
     ...
     * <p>
     * This method processes GET requests to the {@code /ui/v1/students/{studentId}/change-pass} endpoint.
     * It initializes a {@link PasswordUpdateRequestDto} object with the specified student's ID and adds it
     * to the model, which will be used in the password update form view. Users must have the {@code STUDENTS_UPDATE}
